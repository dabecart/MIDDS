                  ...
                  TIM_HandleTypeDef* htim3, TIM_HandleTypeDef* htim4, TIM_HandleTypeDef* htim5)
{
    ...
    // Ch 00: TIM5_4
    initHWTimer_(currentChannel++, htim5, TIM_CHANNEL_4, CH00_GPIO_Port,  CH00_Pin, channelNumber++, 0);
    // Ch 01: TIM3_2
    initHWTimer_(currentChannel++, htim3, TIM_CHANNEL_2, CH01_GPIO_Port,  CH01_Pin, channelNumber++, 0);
    // Ch 02: TIM3_1
    initHWTimer_(currentChannel++, htim3, TIM_CHANNEL_1, CH02_GPIO_Port,  CH02_Pin, channelNumber++, 0);
    // Ch 03: TIM3_3
    initHWTimer_(currentChannel++, htim3, TIM_CHANNEL_3, CH03_GPIO_Port,  CH03_Pin, channelNumber++, 0);
    // Ch 04: TIM3_4
    initHWTimer_(currentChannel++, htim3, TIM_CHANNEL_4, CH04_GPIO_Port,  CH04_Pin, channelNumber++, 0);
    // Ch 05: TIM5_1
    initHWTimer_(currentChannel++, htim5, TIM_CHANNEL_1, CH05_GPIO_Port,  CH05_Pin, channelNumber++, 0);
    // Ch 06: TIM2_3
    initHWTimer_(currentChannel++, htim2, TIM_CHANNEL_3, CH06_GPIO_Port,  CH06_Pin, channelNumber++, 0);
    // Ch 07: TIM2_4
    initHWTimer_(currentChannel++, htim2, TIM_CHANNEL_4, CH07_GPIO_Port,  CH07_Pin, channelNumber++, 0);
    // Ch 08: TIM1_2
    initHWTimer_(currentChannel++, htim1, TIM_CHANNEL_2, CH08_GPIO_Port,  CH08_Pin, channelNumber++, 0);
    // Ch 09: TIM1_3
    initHWTimer_(currentChannel++, htim1, TIM_CHANNEL_3, CH09_GPIO_Port,  CH09_Pin, channelNumber++, 0);
    // Ch 10: TIM2_2
    initHWTimer_(currentChannel++, htim2, TIM_CHANNEL_2, CH10_GPIO_Port,  CH10_Pin, channelNumber++, 0);
    // Ch 11: TIM4_1
    initHWTimer_(currentChannel++, htim4, TIM_CHANNEL_1, CH11_GPIO_Port,  CH11_Pin, channelNumber++, 0);
    // Ch 12: TIM4_4
    initHWTimer_(currentChannel++, htim4, TIM_CHANNEL_4, CH12_GPIO_Port,  CH12_Pin, channelNumber++, 0);
    // Ch 13: TIM2_1
    initHWTimer_(currentChannel++, htim2, TIM_CHANNEL_1, CH13_GPIO_Port,  CH13_Pin, channelNumber++, 0);
    // Ch 14: TIM5_2
    initHWTimer_(currentChannel++, htim5, TIM_CHANNEL_2, CH14_GPIO_Port,  CH14_Pin, channelNumber++, 0);
    // Ch 15: TIM5_3
    initHWTimer_(currentChannel++, htim5, TIM_CHANNEL_3, CH15_GPIO_Port,  CH15_Pin, channelNumber++, 0);
}
